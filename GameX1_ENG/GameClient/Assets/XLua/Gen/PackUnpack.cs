...
namespace XLua
{
    public static partial class CopyByValue
    {
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out UnityEngine.Mathf val)
		{
		    val = new UnityEngine.Mathf();
            int top = LuaAPI.lua_gettop(L);
			
		}
		
        public static bool Pack(IntPtr buff, int offset, UnityEngine.Mathf field)
        {
            
            return true;
        }
        public static bool UnPack(IntPtr buff, int offset, out UnityEngine.Mathf field)
        {
            field = default(UnityEngine.Mathf);
            
            return true;
        }
        
		
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out UnityEngine.AnimatorStateInfo val)
		{
		    val = new UnityEngine.AnimatorStateInfo();
            int top = LuaAPI.lua_gettop(L);
			
		}
		
        public static bool Pack(IntPtr buff, int offset, UnityEngine.AnimatorStateInfo field)
        {
            
            return true;
        }
        public static bool UnPack(IntPtr buff, int offset, out UnityEngine.AnimatorStateInfo field)
        {
            field = default(UnityEngine.AnimatorStateInfo);
