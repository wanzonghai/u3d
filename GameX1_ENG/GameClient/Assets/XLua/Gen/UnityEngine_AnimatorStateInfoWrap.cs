    ...
    public class UnityEngineAnimatorStateInfoWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.PushUnityEngineAnimatorStateInfo(L, default(UnityEngine.AnimatorStateInfo));
			        return 1;
				}
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        translator.UpdateUnityEngineAnimatorStateInfo(L, 1, gen_to_be_invoked);
