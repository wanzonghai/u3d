...
public static class XLuaGen
{
    ...
    {
        //typeof(PostWebRequestEvent),
        //typeof(PostWebRequestWithBytes),
        //typeof(PostWebPhotoInspectEvent),
        typeof(Action),
        ...
        typeof(EventUtils.EventPhysical),
