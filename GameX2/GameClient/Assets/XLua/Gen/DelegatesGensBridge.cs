...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public string __Gen_Delegate_Imp9(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(UnityEngine.UI.Image p0, string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(IceMark.UI.IceButton p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(UnityEngine.GameObject p0, UnityEngine.EventSystems.PointerEventData p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new EventUtils.LinkTexthEvent(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(EventUtils.ImageTexthEvent))
			{
			    return new EventUtils.ImageTexthEvent(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(EventUtils.EventWithVector2))
			{
			    return new EventUtils.EventWithVector2(__Gen_Delegate_Imp11);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.GameObject>(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(UIEventListener.VoidDelegate))
			{
			    return new UIEventListener.VoidDelegate(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<IceMark.UI.IceButton>))
			{
			    return new UnityEngine.Events.UnityAction<IceMark.UI.IceButton>(__Gen_Delegate_Imp13);
			}
			...
			{
			    return new DG.Tweening.Core.DOGetter<int>(__Gen_Delegate_Imp15);
			}
