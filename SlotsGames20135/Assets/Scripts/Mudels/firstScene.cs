...
public class firstScene : MonoBehaviour
{
    ...
    private void InintView()
    {
        ...
        this.mgr.bkMusic = Mid.transform?.GetComponent<AudioSource>();
        this.mgr.soundObj = Bot;
    }
    ...
    {
        if (gameDate.playBK) this.mgr.PlayBkMusic(gameDate.channel_id.ToString());
        else this.mgr.PauseBKMusic();
    }
    private void UpdateView()
    {
        label_coin.text = gameDate.coinNum.ToString();
    }
