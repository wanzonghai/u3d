...
namespace XLua.CSObjectWrap
{
    ...
    public class HotFixManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "StartPlayAndDown", _m_StartPlayAndDown);
        ...
        static int _m_GetInstance_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = HotFixManager.GetInstance(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_StartPlayAndDown(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.StartPlayAndDown( _url );
