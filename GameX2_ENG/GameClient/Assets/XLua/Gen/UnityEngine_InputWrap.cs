...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineInputWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 20, 27, 6);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetPenEvent", _m_GetPenEvent_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetLastPenContactEvent", _m_GetLastPenContactEvent_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ResetPenEvents", _m_ResetPenEvents_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ClearLastPenContactEvent", _m_ClearLastPenContactEvent_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "penEventCount", _g_get_penEventCount);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPenEvent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = UnityEngine.Input.GetPenEvent( _index );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLastPenContactEvent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.Input.GetLastPenContactEvent(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ResetPenEvents_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearLastPenContactEvent_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_penEventCount(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.xlua_pushinteger(L, UnityEngine.Input.penEventCount);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
