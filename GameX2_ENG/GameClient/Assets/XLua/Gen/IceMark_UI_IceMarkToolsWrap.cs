...
namespace XLua.CSObjectWrap
{
    ...
    public class IceMarkUIIceMarkToolsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IceMark.UI.IceMarkTools);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new IceMark.UI.IceMarkTools();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IceMark.UI.IceMarkTools constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.GameObject _prefab = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
                        ...
                        var gen_ret = IceMark.UI.IceMarkTools.AddChild( _parent, _prefab );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Destroy_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    IceMark.UI.IceMarkTools.Destroy( _obj );
