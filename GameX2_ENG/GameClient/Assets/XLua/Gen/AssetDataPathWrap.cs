...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetDataPathWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 2, 10, 10);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "showEception", _g_get_showEception);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "showEception", _s_set_showEception);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_showEception(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushboolean(L, AssetDataPath.showEception);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_showEception(RealStatePtr L)
        {
		    try {
                
			    AssetDataPath.showEception = LuaAPI.lua_toboolean(L, 1);
