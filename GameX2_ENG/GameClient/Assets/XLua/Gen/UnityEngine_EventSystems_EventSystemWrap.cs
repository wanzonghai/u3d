...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsEventSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "SetUITookitEventSystemOverride", _m_SetUITookitEventSystemOverride_xlua_st_);
        ...
        static int _m_IsPointerOverGameObject(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsPointerOverGameObject(  );
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _pointerId = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsPointerOverGameObject( _pointerId );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetUITookitEventSystemOverride_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.EventSystems.EventSystem>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.EventSystems.EventSystem _activeEventSystem = (UnityEngine.EventSystems.EventSystem)translator.GetObject(L, 1, typeof(UnityEngine.EventSystems.EventSystem));
                    bool _sendEvents = LuaAPI.lua_toboolean(L, 2);
                    bool _createPanelGameObjectsOnStart = LuaAPI.lua_toboolean(L, 3);
                    
                    UnityEngine.EventSystems.EventSystem.SetUITookitEventSystemOverride( _activeEventSystem, _sendEvents, _createPanelGameObjectsOnStart );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.EventSystems.EventSystem>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    UnityEngine.EventSystems.EventSystem _activeEventSystem = (UnityEngine.EventSystems.EventSystem)translator.GetObject(L, 1, typeof(UnityEngine.EventSystems.EventSystem));
                    bool _sendEvents = LuaAPI.lua_toboolean(L, 2);
                    
                    UnityEngine.EventSystems.EventSystem.SetUITookitEventSystemOverride( _activeEventSystem, _sendEvents );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.EventSystems.EventSystem>(L, 1)) 
                {
                    UnityEngine.EventSystems.EventSystem _activeEventSystem = (UnityEngine.EventSystems.EventSystem)translator.GetObject(L, 1, typeof(UnityEngine.EventSystems.EventSystem));
                    
                    UnityEngine.EventSystems.EventSystem.SetUITookitEventSystemOverride( _activeEventSystem );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.EventSystems.EventSystem.SetUITookitEventSystemOverride!");
