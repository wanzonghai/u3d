...
{
    public static int ChannelStatus = 2;//多语言版本用  0代表编辑器  1代表微信小程序  2代表google
    public static bool IsAssetBundle = true;//资源用asset的开关
    public static bool IsScriptBundle = true;//代码用asset的开关
