...
namespace XLua.CSObjectWrap
{
    ...
    public class GooglePlayWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RewardedAdFunc", _m_RewardedAdFunc);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RewardedAdFunc(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _rewaed_statue = LuaAPI.lua_tostring(L, 2);
                    
                    gen_to_be_invoked.RewardedAdFunc( _rewaed_statue );
