...
public class GooglePlay : MonoBehaviour
{
    ...
    {
        // 调用 Android 原生方法
        AndroidJavaClass jc = new AndroidJavaClass("com.unity3d.player.AppGoogleAdMob");

        jc.CallStatic("loadRewardedAd");
        //    if (_rewardedAd != null)
        //    {
        //        _rewardedAd.Destroy();
        //        _rewardedAd = null;
    ...
    public void ShowRewardedAd()
    {
        ...
        jc.CallStatic("ShowRewardeVideoHandle");
    }
    public void RewardedAdFunc(string rewaed_statue)
    {
        if (this.func != null)
        {
            this.func.Call();
