...
{
    public static int ChannelStatus = 0;//多语言版本用  0代表编辑器  1代表微信小程序  2代表google
    ...
    public AssetDataPath()
    {
        ...
        {
            Debug.Log("this`s WEBGL");
            OS = OperatingSystem.WEBGL;
        }
