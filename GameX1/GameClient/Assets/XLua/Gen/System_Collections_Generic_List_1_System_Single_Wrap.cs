...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1_SystemSingle_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(System.Collections.Generic.List<float>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new System.Collections.Generic.List<float>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.List<float>(_capacity);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEnumerable<float>>(L, 2))
				{
					System.Collections.Generic.IEnumerable<float> _collection = (System.Collections.Generic.IEnumerable<float>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<float>));
					
					var gen_ret = new System.Collections.Generic.List<float>(_collection);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<float>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					System.Collections.Generic.List<float> gen_to_be_invoked = (System.Collections.Generic.List<float>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<float>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int _m_Add(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _item = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _m_BinarySearch(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Collections.Generic.IComparer<float>>(L, 3)) 
                {
                    float _item = (float)LuaAPI.lua_tonumber(L, 2);
                    System.Collections.Generic.IComparer<float> _comparer = (System.Collections.Generic.IComparer<float>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IComparer<float>));
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<System.Collections.Generic.IComparer<float>>(L, 5)) 
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                    float _item = (float)LuaAPI.lua_tonumber(L, 4);
                    System.Collections.Generic.IComparer<float> _comparer = (System.Collections.Generic.IComparer<float>)translator.GetObject(L, 5, typeof(System.Collections.Generic.IComparer<float>));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.BinarySearch!");
        ...
        static int _m_CopyTo(RealStatePtr L)
        {
		    try {
                ...
                {
                    float[] _array = (float[])translator.GetObject(L, 2, typeof(float[]));
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<float[]>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    float[] _array = (float[])translator.GetObject(L, 3, typeof(float[]));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.CopyTo!");
        ...
        static int _m_Exists(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Predicate<float> _match = translator.GetDelegate<System.Predicate<float>>(L, 2);
        ...
        static int _m_FindIndex(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Predicate<float>>(L, 2)) 
                {
                    System.Predicate<float> _match = translator.GetDelegate<System.Predicate<float>>(L, 2);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Predicate<float>>(L, 3)) 
                {
                    int _startIndex = LuaAPI.xlua_tointeger(L, 2);
                    System.Predicate<float> _match = translator.GetDelegate<System.Predicate<float>>(L, 3);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Predicate<float>>(L, 4)) 
                {
                    int _startIndex = LuaAPI.xlua_tointeger(L, 2);
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                    System.Predicate<float> _match = translator.GetDelegate<System.Predicate<float>>(L, 4);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.FindIndex!");
        ...
        static int _m_FindLastIndex(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.FindLastIndex!");
        ...
        static int _m_ForEach(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Action<float> _action = translator.GetDelegate<System.Action<float>>(L, 2);
        ...
        static int _m_IndexOf(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.IndexOf!");
        ...
        static int _m_Insert(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    float _item = (float)LuaAPI.lua_tonumber(L, 3);
        ...
        static int _m_InsertRange(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.IEnumerable<float> _collection = (System.Collections.Generic.IEnumerable<float>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IEnumerable<float>));
        ...
        static int _m_LastIndexOf(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.LastIndexOf!");
        ...
        static int _m_Reverse(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.Reverse!");
        ...
        static int _m_Sort(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Collections.Generic.IComparer<float>>(L, 2)) 
                {
                    System.Collections.Generic.IComparer<float> _comparer = (System.Collections.Generic.IComparer<float>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IComparer<float>));
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Comparison<float>>(L, 2)) 
                {
                    System.Comparison<float> _comparison = translator.GetDelegate<System.Comparison<float>>(L, 2);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Collections.Generic.IComparer<float>>(L, 4)) 
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                    System.Collections.Generic.IComparer<float> _comparer = (System.Collections.Generic.IComparer<float>)translator.GetObject(L, 4, typeof(System.Collections.Generic.IComparer<float>));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<float>.Sort!");
