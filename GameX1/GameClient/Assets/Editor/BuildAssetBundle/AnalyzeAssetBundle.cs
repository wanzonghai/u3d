...
public class AnalyzeAssetBundle
{
    ...
    {
        get { return new ExcelReader(ExcelUtils.DataPath + "Excel/" + "Z_资源.xlsx"); }
    }
    ...
    public static void AssetBundleAnalyze()
    {
        ...
        //资产文件（非序列化）
        dependPath.AddRange(ParseDirectory("Assets/Resources/Atlas/", new string[] { "*.png", "*.fnt", "*.fontsettings", "*.otf", "*.ttf", "*.asset" }));
        ...
        //dependPath.AddRange(ParseDirectory("Assets/Resources/Role/", new string[] { "*.png", "*.tif", "*.jpg", "*.psd", "*.tga", "*.fbx" }));

        //序列化文件
        //employPaths.AddRange(ParseDirectory("Assets/Resources/Atlas/Dynamic/", new string[] { "*.png" }));
        ...
        //employPaths.AddRange(ParseDirectory("Assets/Resources/Role/", new string[] { "*.prefab" }));
        employPaths.AddRange(ParseDirectory("Assets/Resources/Windows/", new string[] { "*.prefab" }));
